...
public class AdminController {
    ...
    public ModelAndView displayClasses(Model model) {
        ...
        modelAndView.addObject("eazyClasses", expertClasses);
        modelAndView.addObject("eazyClass", new ExpertClass());
        return modelAndView;
    }

    @PostMapping("/addNewClass")
    public ModelAndView addNewClass(Model model, @ModelAttribute("eazyClass") ExpertClass expertClass) {
    ...
    public ModelAndView deleteClass(Model model, @RequestParam int id) {
        Optional<ExpertClass> eazyClass = expertClassRepository.findById(id);
    ...
    public ModelAndView displayStudents(Model model, @RequestParam int classId, HttpSession session,
        ...
        Optional<ExpertClass> eazyClass = expertClassRepository.findById(classId);
    ...
    public ModelAndView addStudent(Model model, @ModelAttribute("person") Person person, HttpSession session) {
        ...
        ExpertClass expertClass = (ExpertClass) session.getAttribute("eazyClass");
    ...
    public ModelAndView deleteStudent(Model model, @RequestParam int personId, HttpSession session) {
        ...
        session.setAttribute("eazyClass", expertClassSaved);
