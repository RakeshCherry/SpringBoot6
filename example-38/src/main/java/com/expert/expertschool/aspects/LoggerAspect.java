package com.expert.expertschool.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.expertbytes.expertschool..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.expertbytes.expertschool.*.*(..))",throwing = "ex")
